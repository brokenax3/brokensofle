...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_UPPER] = LAYOUT(KC_TRNS, LGUI(KC_F1), LGUI(KC_F2), LGUI(KC_F3), LGUI(KC_F4), LGUI(KC_F5), LGUI(KC_F6), LGUI(KC_F7), LGUI(KC_F8), LGUI(KC_F9), LGUI(KC_F10), LGUI(KC_F11), KC_TRNS, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PIPE, KC_H, KC_J, KC_K, KC_L, KC_NO, LGUI(KC_F12), KC_TRNS, KC_NO, KC_BSLS, KC_UNDS, KC_MINS, KC_ASTR, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_CIRC, KC_EQL, KC_PLUS, KC_PERC, KC_TRNS, KC_TRNS, KC_HOME, KC_PGUP, KC_PGDN, KC_END, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(4), KC_TRNS, KC_TRNS, KC_TRNS),
	[_LOWER] = LAYOUT(KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_AT, KC_HASH, KC_AMPR, KC_LCBR, KC_RCBR, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_ESC, KC_COLN, KC_GRV, KC_QUOT, KC_LBRC, KC_RBRC, KC_EQL, KC_BSLS, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_LT, KC_GT, KC_EXLM, KC_TRNS, KC_TRNS, KC_DQUO, KC_LPRN, KC_RPRN, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(4), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
